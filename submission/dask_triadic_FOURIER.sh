#!/bin/bash
#SBATCH --job-name=triadic_fourier
#SBATCH --nodes=12
...
# Run the Fourier triadic-interaction stage
python ../hpda/dask_triadic_FOURIER.py ./$SLURM_JOB_ID-scheduler.json $in_dir $seq_file $out_dir $nsnaps
